...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    @Override
    public void loadBeanDefinition(Resource location) throws BeansException {
        try (InputStream is = location.getInputStream()) {
            doLoadBeanDefinition(is);
        } catch (IOException | DocumentException | ClassNotFoundException e) {
            throw new BeansException("IOException parsing XML document from " + location, e);
        }
    }

    private void doLoadBeanDefinition(InputStream is) throws DocumentException, ClassNotFoundException {
    ...
    @Override
    public void loadBeanDefinition(Resource... locations) throws BeansException {
